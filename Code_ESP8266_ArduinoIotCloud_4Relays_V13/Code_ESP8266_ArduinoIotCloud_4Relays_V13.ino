...
const char DEVICE_LOGIN_NAME[]  = "2fabf6a5-e763-4372-8288-4561b1da81f8"; //Enter DEVICE ID

const char SSID[]               = "SLTC_STAFF";    //Enter WiFi SSID (name)
const char PASS[]               = "Nwg6W1Wx";    //Enter WiFi password
const char DEVICE_KEY[]         = "D2UXWAJZTRTWCAYYNNCN";    //Enter Secret device password (Secret Key)
